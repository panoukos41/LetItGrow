...
{
    public class IrrigationStettingsValidatorTests
    {
        private static readonly IrrigationSettingsValidator Validator = new();

        [Fact]
        public void Should_Pass_Validation()
        {
            // Arrange
            var settings = new IrrigationSettings();
        ...
        {
            // Arrange
            var settings = new IrrigationSettings(pollInterval);
