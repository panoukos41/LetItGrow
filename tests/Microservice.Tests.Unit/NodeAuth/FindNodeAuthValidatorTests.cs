...
{
    public class FindNodeAuthValidatorTests
    {
        private static readonly FindNodeAuthValidator Validator = new();

        private static readonly Faker<FindNodeAuth> Faker = new();
