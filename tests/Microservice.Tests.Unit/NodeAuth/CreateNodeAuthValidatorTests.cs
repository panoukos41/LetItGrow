...
{
    public class CreateNodeAuthValidatorTests
    {
        private static readonly CreateNodeAuthValidator Validator = new();

        private static readonly Faker<CreateNodeAuth> Faker = new();
